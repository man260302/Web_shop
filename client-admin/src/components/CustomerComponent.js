    ...
    return (
      <div>
        ...
        <div className="cus-menu">
          <h2 className="text-cus">DANH SÁCH KHÁCH HÀNG</h2>
        ...
        {this.state.orders.length > 0 ?
          <div className="or-ad">
            <h2 className="text-cus">DANH SÁCH ĐẶT HÀNG</h2>
            <table className="datatable" border="1">
              <tbody>
                <tr className="datatable">
                  <th>ID</th>
        ...
        {this.state.order ?
          <div className="or-ad">
            <h2 className="text-cus">CHI TIẾT ĐẶT HÀNG</h2>
            <table className="datatable" border="1">
              <tbody>
                <tr className="datatable">
                  <th>No.</th>
